...
<div class="col-xs-12 col-sm-12 col-md-12">
    ...
    {!! Form::text('discount', @$project->discount, ['class' => 'form-control', 'required','placeholder' => 'Discount',  'pattern'=> '^[a-zA-Z0-9_.-]*$' ]) !!}
</div>
<div class="col-xs-12 col-sm-12 col-md-12">
    {!! Form::label('sales_price', 'Sales Price:' )  !!}
    {!! Form::text('sales_price', @$project->sales_price, ['class' => 'form-control', 'required','placeholder' => 'Sales Price',  'pattern'=> '^[a-zA-Z0-9_.-]*$' ]) !!}
</div>
<div class="col-xs-12 col-sm-12 col-md-12">
